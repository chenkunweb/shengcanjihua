                ...
                <div >
                    ...
                    <el-dialog title="查找数据" ref="contents" class="fixeds" width='750px' :append-to-body="true" :close-on-click-modal="false" v-dialogDrag :modal="false" :visible.sync="dialogFormVisible">
                        <div style="display:flex">
                            ...
                            <!-- <el-button @click="contentOne">查找下一个</el-button> -->
...
<script>
  ...
  export default {
    ...
    methods:{
       ...
       //背景颜色选择器
        headleChangeBGColor(e){let a = 'BG';let b = 'BG,';this.util.style(a,b,e,_this);this.util.headleChangeBGColor(_this,e,'zlj',1);_this.a.render()},
        //字体颜色选择器
        headleChangeColor(e){let a = 'color';let b = 'color,';this.util.style(a,b,e,_this);this.util.headleChangeColor(_this,e,'zlj',1);_this.a.render()},
        //加粗
        blod(e){let a = 'blod';let b = 'blod,';this.util.style(a,b,e,_this);this.util.blod(_this,e,'zlj',1);_this.a.render()},
        // 字体大小
        size(e){let a = 'size';let b = 'size,';this.util.style(a,b,e,_this);this.util.size(_this,e,'zlj',1);_this.a.render()},
         // 清空查询数据
