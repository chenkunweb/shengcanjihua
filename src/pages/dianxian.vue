...
export default {
    ...
    data(){
        return{
            ...
            hotSettings: {
                ...
                contextMenu:_this.util.contextMenu(_this),//y右键菜单
    ...
    // 实例创建完
    created(){
        this.$store.state.path = window.location.hash.split('/')[1]//this赋值
         this.util.GetData(this)//记忆路由
        //样品最大编号
    ...
    methods:{
        ...
        //背景颜色选择器
        headleChangeBGColor(e){let a = 'BG';let b = 'BG,';this.util.style(a,b,e,_this);this.util.headleChangeBGColor(_this,e,'dx',1);_this.a.render()},
        //字体颜色选择器
        headleChangeColor(e){let a = 'color';let b = 'color,';this.util.style(a,b,e,_this);this.util.headleChangeColor(_this,e,'dx',1);_this.a.render()},
        //加粗
        blod(e){let a = 'blod';let b = 'blod,';this.util.style(a,b,e,_this);this.util.blod(_this,e,'dx',1);_this.a.render()},
        // 字体大小
        size(e){let a = 'size';let b = 'size,';this.util.style(a,b,e,_this);this.util.size(_this,e,'dx',1);_this.a.render()},
        // 下载文件
        ...
        //保存
        down(){_this.util.down(this,'http://www.zanty.net:8013?date=')},
     
        //日期查询
        change(e){
           _this.util.change(e,this,'dx')
            this.maxyps = 0
           this.maxyds = 0
            // 样品最大编号
            this.$api.get('/api/Plangetp','',res=>{
